...
static dwt_local_data_t *pdw1000local = NULL ; // Static local data structure pointer
 ...
 */
void dwt_setdevicedataptr(dwt_local_data_t *pdata)
{
    pdw1000local = pdata;
}
...
int dwt_initialise(uint16 config) {
  ...
  devid = dwt_readdevid();
  // MP IC ONLY (i.e. DW1000) FOR THIS CODE
